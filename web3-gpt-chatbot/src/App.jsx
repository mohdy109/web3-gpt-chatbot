...
//     const [nfts, transfers,tokens] = await Promise.all([fetchNFTs, fetchTransfers,fetchTokens]);
...
//         <h1 className="text-4xl font-bold text-center">🧠 GPT Web3 Chatbot</h1>
...
//         {ethBalance && (
//           <p className="text-yellow-400 text-center">💵 ETH Balance: {ethBalance} ETH</p>
//         )}

//         <div>
//           <h2 className="text-xl font-semibold mb-2">🖼️ NFTs</h2>
//           <div className="bg-gray-800 p-4 rounded overflow-x-auto text-sm">
...
//         <div>
//           <h2 className="text-xl font-semibold mb-2">🗳️ DAO Votes (Snapshot)</h2>
//           <div className="bg-gray-800 p-4 rounded overflow-x-auto text-sm">
...
//           <button
//             onClick={() => askBot()}
//             className="bg-green-600 hover:bg-green-700 px-4 py-2 rounded shadow w-full"
//           >
//             Ask
//           </button>
